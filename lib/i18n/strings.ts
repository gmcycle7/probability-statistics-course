...
export const STRINGS = {
  ...
  "home.continue.eyebrow": { zh: "繼續上次的學習", en: "Continue where you left off" },
  "home.continue.cta": { zh: "回到這一章", en: "Resume chapter" },
  "home.continue.complete": { zh: "已完成", en: "completed" },
  "home.continue.notDone": { zh: "未完成", en: "in progress" },
